...
const variants = Object.freeze({
  ...
  "success": joinClassNames("bg-green-300 hover:bg-green-400 dark:bg-green-900 dark:hover:bg-green-800 dark:text-white", PRIMARY_COMMON),
  ...
  "outline-success": joinClassNames("border-green-400 text-green-500 hover:bg-green-400 hover:text-white dark:border-green-700 text-green-600 dark:hover:bg-green-600 dark:hover:border-green-600", OUTLINE_COMMON),
